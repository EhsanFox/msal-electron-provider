...
import { BrowserWindow, IpcMain, ipcMain, Protocol } from "electron";
...
export class ElectronAuthenticator {
  ...
  private ms_config: Configuration | undefined;
   ...
   * @memberof ElectronAuthenticator
   */
  public clientApplication: PublicClientApplication | undefined;
   ...
   * @memberof ElectronAuthenticator
   */
  public authWindow: BrowserWindow | undefined;
   ...
   * @memberof ElectronAuthenticator
   */
  private authCodeUrlParams: AuthorizationUrlRequest | undefined;
   ...
   * @memberof ElectronAuthenticator
   */
  private authCodeRequest: AuthorizationCodeRequest | undefined;
   ...
   * @memberof ElectronAuthenticator
   */
  private authCodeListener: CustomFileProtocolListener | undefined;
  ...
  public static initialize(
    ...
    if (!ElectronAuthenticator.instance) {
      ElectronAuthenticator.authInstance = new ElectronAuthenticator(
        config,
        ipcMain,
        protocol
      );
  ...
  protected setupProvider() {
    ...
    this.ipcMain.handle(
      "token",
      async (_e: unknown, options: AuthenticationProviderOptions) => {
  ...
  protected async getAccessToken(
    ...
    let authResponse: AuthenticationResult | null | undefined = null;
  ...
  protected async login() {
    ...
    return this.setAccountFromResponse(authResponse as AuthenticationResult);
  }
   ...
   * @memberof ElectronAuthenticator
   */
  protected async getTokenInteractive(
  ...
  private async listenForAuthCode(
    ...
    return new Promise((resolve, reject) => {
      this.authWindow?.webContents.on(
        "will-redirect",
        (_event: unknown, responseUrl: string) => {
          try {
